...
This library serves as a universal pipe for moving data around between Django applications and services. It is built on
top of [Boto3][boto3], [Apache Kafka][apachekafka]], [kafka-python][kafka-python], and [Django REST Framework][drf].
